...
from ext_libs.androguard.core import androconf
from ext_libs.androguard.core.bytecodes.dvm_permissions import DVM_PERMISSIONS
from ext_libs.androguard.util import read

from ext_libs.androguard.core.resources import public
...
class APK(object):
    ...
    def __init__(self,
        ...
        if zipmodule == 0:
            ...
            from ext_libs.androguard.patch import zipfile
